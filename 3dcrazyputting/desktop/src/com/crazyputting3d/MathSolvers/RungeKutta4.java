...
public class RungeKutta4 extends Solver{
    ...
    public StateVector run(StateVector a, double m) {
        ...
        double vx0 = a.getVX();
        double vy0 = a.getVY();
        double ax1 = engine.acelerationX(x0, y0, vx0, vy0, m);
        double ay1 = engine.acelerationY(x0, y0, vx0, vy0, m);
        ...
        double ax2 = engine.acelerationX(x1, y1, vx1, vy1, m);
        double ay2 = engine.acelerationY(x1, y1, vx1, vy1, m);
        ...
        double ax3 = engine.acelerationX(x2, y2, vx2, vy2, m);
        double ay3 = engine.acelerationY(x2, y2, vx2, vy2, m);
        ...
        double ax4 = engine.acelerationX(x3, y3, vx3, vy3, m);
        double ay4 = engine.acelerationY(x3, y3, vx3, vy3, m);
